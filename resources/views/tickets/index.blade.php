                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-slate-700/30 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        @php
                                            $statusColors = [
                                                ...
                                                'open' => 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400 border border-red-200 dark:border-red-800',
                                                'in_progress' => 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400 border border-blue-200 dark:border-blue-800',
                                                ...
                                                'resolved' => 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400 border border-green-200 dark:border-green-800',
                                            ];
                                            $statusBadgeClass = $statusColors[$ticket->status] ?? 'bg-gray-100 text-gray-700 dark:bg-gray-700/50 dark:text-gray-300 border border-gray-200 dark:border-gray-600';
                                        @endphp
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        @php
                                            ...
                                            $priorityBadgeClass = $priorityColors[$ticket->priority] ?? 'bg-gray-100 text-gray-700 dark:bg-gray-700/50 dark:text-gray-300 border border-gray-200 dark:border-gray-600';
                                        @endphp
                                        <span class="px-3 py-1 rounded-full text-xs font-bold {{ $priorityBadgeClass }}">
                                            {{ __('app.' . $ticket->priority) }}
                                        </span>
                                    </td>
