<div class="space-y-6">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
            <label for="name" class="block font-medium text-sm text-gray-700">نام قطعه (مثال: Laptop Dell XPS 15)</label>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
            ...
            <select id="status" name="status" class="form-input-custom mt-1 block w-full">
                ...
                <option value="decommissioned" @selected(old('status', $asset->status ?? '') == 'decommissioned')>از رده خارج</option>
            </select>
    ...
    <div>
        <label for="assigned_to" class="block font-medium text-sm text-gray-700">اختصاص به کاربر (فقط در وضعیت "اختصاص یافته")</label>
